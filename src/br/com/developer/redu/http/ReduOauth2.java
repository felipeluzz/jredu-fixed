...
public class ReduOauth2 extends DefaultApi20 {
    ...
    private static final String AUTHORIZE_URL = "http://openredu.ufpe.br/oauth/authorize?client_id=%s";
    ...
    public String getAccessTokenEndpoint() {
        return "http://openredu.ufpe.br/oauth/token?grant_type=authorization_code";
    }
